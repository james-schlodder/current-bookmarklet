...
(function() {
  ...
  function extractArticleText() {
    ...
    const excludeSelectors = 'figcaption, aside, nav, footer, .related, .newsletter, .ad, .sidebar, .comment, .social-share, [role="complementary"], [class*="author-bio"], [class*="vf-comment"], [class*="vf-content"], [class*="Carousel"], [class*="carousel"]';
